// VaryMemoryTwoSample.cpp
// Experiments that vary in percent of memory
...
int main(int argc, char* argv[])
{
  if (argc < 12)
  {
    cout << "usage: VaryMemoryTwoSample lower-memory upper-memory num-stream(>0) [N|U|P|E] location1 scale1 location2 scale2 [0|1] stream-size num-buckets" << endl;
  ...
  if (lower <= 0)
  {
    cout << "The lower percent of memory must be greater than 0.\n";
    throw ParameterError();
  }
  if (num_buckets <= 0)
  {
